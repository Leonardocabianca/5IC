...
public class Quiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        question.add(new question("Domanda1",true));
        question.add(new question("Domanda2",true));
        question.add(new question("Domanda3",false));
        question.add(new question("Domanda4",true));
        question.add(new question("Domanda5",false));
